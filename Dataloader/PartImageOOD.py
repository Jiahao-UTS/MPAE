...
class PartImageNet_Dataset(Dataset):
    def __init__(self, cfg, root, is_train, transform=None):
        ...
        if is_train:
            self.anno_path = os.path.join(root, 'train_train.json')
        else:
            self.anno_path = os.path.join(root, 'train_test.json')
    ...
    def get_file_information(self):
        ...
        for image_id in self.image_ids:
            ...
            if anns:
                ...
                self.image_id_to_name[filtered_img_iterator] = os.path.join(self.root, "train",
                                                                            img_name)
