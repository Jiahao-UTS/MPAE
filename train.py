...
def parse_args():
    parser = argparse.ArgumentParser(description='Train Mask Part AutoEncoder')
    parser.add_argument('--Dataset', type=str, default='PartImage_Seg')
    parser.add_argument('--Num_Part', type=int, default=51)
    parser.add_argument('--Epoch', type=int, default=70)
    parser.add_argument('--LR_step', nargs='+', type=int, default=[50, 60])
...
def main_function():
    ...
    if cfg.DATASET.DATASET == 'CelebA':
        ...
        train_dataset = PartImageNet_Dataset(
            cfg, cfg.PartImageNet.ROOT,  True,
            [
                transforms.ToTensor(),
                normalize,
            ]
        ...
        train_dataset = PartImageNet_Seg_Dataset(
            cfg, cfg.PartImageNet.Seg_ROOT,  True,
            [
                transforms.ToTensor(),
                normalize,
            ]
